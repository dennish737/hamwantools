...
# Articles
[Network Devices](https://www.geeksforgeeks.org/network-devices-hub-repeater-bridge-switch-router-gateways/?ref=leftbar-rightbar)

[Back Bone](https://www.geeksforgeeks.org/types-and-uses-of-backbone-networks/)

[Routing vs. Bridging Wireless Networks](https://techsoftcenter.com/routing-vs-bridging-on-wireless-point-to-point-in-mikrotik-router/)

[Packet Flow in RouterOS](https://help.mikrotik.com/docs/display/ROS/Packet+Flow+in+RouterOS)

[RouterOS basic OSPF router configuration](https://www.uni-koeln.de/~pbogusze/posts/RouterOS_basic_OSPF_router_configuration.html)

[OSPF Explained](https://www.packetcoders.io/ospf-areas-explained/)
...
# Videos
[General Mikrotik Training](https://www.youtube.com/watch?v=ynmsapjWGxY&list=RDCMUChAnP0FHKtlj_BypECp-40w&start_radio=1&rv=ynmsapjWGxY&t=4)

[OSPF](https://www.youtube.com/watch?v=kfvJ8QVJscc)

[OSPF Deep Dive](https://www.youtube.com/watch?v=b6RIqXo_qvA)

[Single Area OSPF](https://www.youtube.com/watch?v=ynmsapjWGxY)
